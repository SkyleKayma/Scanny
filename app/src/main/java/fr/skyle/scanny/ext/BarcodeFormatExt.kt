...
val BarcodeFormat.value: Int
    get() = when (this) {
        ...
        BarcodeFormat.BARCODE -> Barcode.FORMAT_CODABAR
...
val BarcodeFormat.textId
    get() = when (this) {
        ...
        BarcodeFormat.BARCODE -> R.string.barcode_format_barcode
        ...
        BarcodeFormat.ITF -> R.string.barcode_format_itf
        ...
        BarcodeFormat.PDF417 -> R.string.barcode_format_pdf417
