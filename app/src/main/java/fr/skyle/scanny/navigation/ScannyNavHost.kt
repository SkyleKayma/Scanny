...
fun ScannyNavHost(
    ...
    AnimatedNavHost(
        ...
        composable(route = BottomBarScreens.QRScan.route,
            enterTransition = {
                slideIntoContainer(AnimatedContentScope.SlideDirection.Right, animationSpec = tween(SCREEN_TIME_TRANSITION))
            },
            exitTransition = {
                slideOutOfContainer(AnimatedContentScope.SlideDirection.Left, animationSpec = tween(SCREEN_TIME_TRANSITION))
            }
        ) {
            ScanScreen()
        }
        composable(
            ...
            enterTransition = {
                when (initialState.destination.route) {
                    BottomBarScreens.QRScan.route ->
                        slideIntoContainer(AnimatedContentScope.SlideDirection.Left, animationSpec = tween(SCREEN_TIME_TRANSITION))
            ...
            exitTransition = {
                when (targetState.destination.route) {
                    BottomBarScreens.QRScan.route ->
                        slideOutOfContainer(AnimatedContentScope.SlideDirection.Right, animationSpec = tween(SCREEN_TIME_TRANSITION))
                    BottomBarScreens.QRHistory.route, BottomBarScreens.Settings.route ->
                        slideOutOfContainer(AnimatedContentScope.SlideDirection.Left, animationSpec = tween(SCREEN_TIME_TRANSITION))
